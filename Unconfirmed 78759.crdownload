...
def get_yolo_preds(net, input_vid_path, output_vid_path, confidence_threshold, overlapping_threshold, write_output, show_display, labels):
    ...
    W = None
    H = None
    #cap = cv2.VideoCapture(input_vid_path,cv2.CAP_FFMPEG)
